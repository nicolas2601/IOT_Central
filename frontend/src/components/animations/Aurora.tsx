...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    function resize() {
      if (!ctn) return;
      const width = (ctn as HTMLElement).offsetWidth;
      const height = (ctn as HTMLElement).offsetHeight;
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uResolution: { value: [(ctn as HTMLElement).offsetWidth, (ctn as HTMLElement).offsetHeight] },
        uBlend: { value: blend }
      }
    });

    const mesh = new Mesh(gl, { geometry, program });
    (ctn as HTMLElement).appendChild(gl.canvas);
